...
def post_detail(request, slug):
    ...
    comments = post.comments.filter(
        parent__isnull=True,
        approved=True
    ).select_related("user").prefetch_related("replies").order_by("-created")
    ...
    # ==================================================
    # CTA LOGIC — ADVANCED BUSINESS MODE
    # ==================================================
    cta = None
    if post.cta_link and post.cta_text != "none":
        cta = {
            "text": post.get_cta_text_display(),
            "link": post.cta_link,
            "price": post.price,
            "instructions": post.instructions,
            "type": post.post_type
